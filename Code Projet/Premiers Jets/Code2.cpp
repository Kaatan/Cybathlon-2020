...
void wrist_adjustment(float& x, float& y, float& z, float alpha, float beta, float& eta) {


    //la position du poignet en tant ue tel est fonction de arm, alpha, forearm et beta. 
    //Il serait sans doute plus pratique de situer le bras en fonction de la position du poignet et non des doigts, 
    //puisque ces derniers sont voués à s'ouvrir, se fermer ou s'incliner
